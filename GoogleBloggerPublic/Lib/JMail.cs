...
namespace PicAndVideoCollect.Lib
{
    class JMail
    {
        ...
        public JMail(string server, string toMail, string fromMail, string subject, string emailBody, string username, string password, string port, bool sslEnable, bool pwdCheckEnable) {
            try
            {
        ...
        public void InsertImage(string filePath)
        {
            ...
            mMailMessage.Body += "<img src=\"cid:" + attachment.ContentId + "\"/>";
        }
